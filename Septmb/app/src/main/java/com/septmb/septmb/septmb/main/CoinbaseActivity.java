...
import com.septmb.septmb.septmb.classes.MainContract;
import com.septmb.septmb.septmb.classes.MainPresenter;
import com.septmb.septmb.septmb.classes.TransactionDialog;
import com.septmb.septmb.septmb.commons.Commons;

import java.util.ArrayList;


public class CoinbaseActivity extends AppCompatActivity implements MainContract.LoginView {
    ...
    private void initViews() {
        ...
        etMoney.setText(Commons.productInfo.getPrice().replace("$","").replace("€","").replace("£","").replace("¥",""));
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                presenter.login(CoinbaseActivity.this);
            }
        });
        ...
        adapter = new ArrayAdapter<>(CoinbaseActivity.this, android.R.layout.simple_list_item_1, android.R.id.text1, new ArrayList<String>());
    ...
    protected void onNewIntent(final Intent intent) {
        if (intent != null && intent.getAction() != null && intent.getAction().equals("android.intent.action.VIEW")) {
            presenter.completeLogin(CoinbaseActivity.this, intent.getData());
        }
    }
