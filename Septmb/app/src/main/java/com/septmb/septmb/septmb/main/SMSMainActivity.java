...
import com.septmb.septmb.septmb.Sms;
import com.septmb.septmb.septmb.adapters.AllConversationAdapter;
import com.septmb.septmb.septmb.adapters.ItemCLickListener;
import com.septmb.septmb.septmb.commons.Commons;
import com.septmb.septmb.septmb.commons.Constants;
import com.septmb.septmb.septmb.commons.SmsContract;
...
public class SMSMainActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    private boolean checkDefaultSettings() {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.KITKAT) {
            ...
            if (!Telephony.Sms.getDefaultSmsPackage(this).equals(getPackageName())) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(SMSMainActivity.this);
    ...
    protected void onResume() {
        ...
        mReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (new_sms)
                    getSupportLoaderManager().restartLoader(Constants.ALL_SMS_LOADER, null, SMSMainActivity.this);
    ...
    public void getAllSmsToFile(Cursor c) {
            ...
            for (int i = 0; i < totalSMS; i++) {
                ...
                try {
                    ...
                    objSMS.setAddress(c.getString(c
                            .getColumnIndexOrThrow("address")));    Log.d("Addr===>",c.getString(c.getColumnIndexOrThrow("address")));
                    ...
                    if(objSMS.getAddress().replace("+","").replace("-","").equals(Commons.user.getPhone().replace("+","").replace("-",""))
                            ||objSMS.getAddress().replace("+","").replace("-","").contains(Commons.user.getPhone().replace("+","").replace("-","")))
                        lstSms.add(objSMS);
                    c.moveToNext();
                }
            }
        ...
        data = lstSms;
        if(lstSms.isEmpty()) {
            ((TextView) findViewById(R.id.NoMessage)).setVisibility(View.VISIBLE);
            ((TextView) findViewById(R.id.NoMessage)).setText("No SMS message received\nfrom "+Commons.user.getName());
        }
        else ((TextView)findViewById(R.id.NoMessage)).setVisibility(View.GONE);
